...
module Arithmetic_Unit (
	...
	localparam STLU = 4'b1001: result = (a < b) ? 1 : 0; // Set Less Than Unsigned
    always @(*) begin
        case(ALU_Control)
            ADD:  ALU_Result = A + B;
            SUB:  ALU_Result = A - B;
...
|0101|SLL|Shift logical left|
|0110|SRL|Shfit logical right|
|0111|SRA|Shift right arthmatic|
|1000|SLT|Set less than|
|1001|SLTU|Set less than unsigned|  
Upon completion of the M extenstension the table will be updated with the following: 
|Binary|Opperation|Explaination|
|---|---|---|
|1010|MULT|Multiply two values|  
## Registers
### RegisterFile.v
```verilog
module RegisterFile (
...
reg [31:0] registers [0:31]; // A register of registers
```  
Creates 32 D flip flops per register address creating a sort of hash table of registers where each registers address is the key and each sub register are the buckets. This can be seen in the RTL Viewer built into verilog.  
![IMG](img/REGZOOM.PNG)  
![IMG](img/REG2.PNG)  
