...
## R Type Instructions
With our ALU and RegisterFile complete we can begin creating the first and easiets instruction set, R Type. R type are our simple functions done by the ALU.  
|Binary|Opperation||
|---|---|---|
|0000|ADD||
|0001|SUB||
